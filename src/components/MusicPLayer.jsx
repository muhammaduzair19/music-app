...
import Profile from '../assets/Mask Group 23.png'
import Path from '../assets/path.png'
import Track from '../assets/Group 9.png'

const MusicPLayer = () => {
    return (
        <div className='flex flex-col px-5 w-[100%] border-2 border-black rounded-xl py-3 bg-[#232A4E] mt-5'>
            <div className="up flex items-center justify-between">
                <div className="profile flex">
                    <img src={Profile} alt="" className="border-white rounded-full w-[2.5rem] h-[2.5rem]" />
                    <div className="flex flex-col ml-4">
                        <span className='text-[1rem]'>aadat</span>
                        <span className='font-bold text-gray-500 text-sm'>aatif aslam</span>
                    </div>
                </div>
                <div>
            ...
            <div className="lp flex justify-between items-center mt-5">
                <div className="track flex justify-between items-center text-sm text-gray-400 flex-[2]">
                    <span>2 : 45</span>
                    <img src={Track} alt="" className='w-[16rem]' />
                    <span>4 : 21</span>
                </div>
